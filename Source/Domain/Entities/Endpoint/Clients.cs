...
public class Clients : BaseEntity
{
    ...
    /// <summary>
    /// Gets or sets a value indicating whether the client application that is registered is a first party app or a third party app.
    ...
    /// <summary>
    /// Gets or sets the allowed signing algorithm for the client.
    /// </summary>
